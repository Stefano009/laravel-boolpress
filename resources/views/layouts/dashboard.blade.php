...
<body>
    <nav class="navbar navbar-expand-md navbar-dark bg-secondary flex-md-nowrap p-0">
    ...
    <div class="container-fluid">
        <div class="row">
            ...
            <main role="main" class="col-md-9 ml-sm-auto col-lg-10 px-4 py-4 bg-light height">
                @yield('content')
            </main>
        </div>
    </div>
